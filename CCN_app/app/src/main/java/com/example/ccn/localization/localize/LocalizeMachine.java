 ...
 */
public class LocalizeMachine {

    @NonNull
    private static final String TAG = "LocalizeMachine";
    ...
    void post(@NonNull LocalizeEvent event) {
        ...
        if (currentState == null){
            throw new IllegalStateException("LocalizeMachine must have a LocalizeState to be able to handle a Localization Event");
        }
    ...
    @NonNull
    Observable<LocalizeState> localizeState() {return subject.distinctUntilChanged(); }
